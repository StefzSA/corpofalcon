...
<body>
	<div id="header" class="w-full z-30">
		<div class="container relative w-full flex flex-wrap py-2 xl:py-1 min-h-[60px] md:min-h-[85px]">
			<div class="absolute z-10 left-0 w-full flex justify-start  items-center md:static md:w-2/12">
			...
			<div class="relative z-20 flex justify-end items-center w-full md:w-10/12">
