...
<main>
    <div class="img w-full min-h-[250px] md:min-h-[330px] relative">
        <div
            class="absolute w-full h-full bg-[rgba(0,0,0,0.7)] bg-[url('http://localhost/corpofalcon/wp-content/uploads/2023/12/medanos.jpg')] bg-cover bg-center bg-blend-color">
        </div>
        <div class="absolute w-full h-full flex justify-center items-center flex-wrap">
            <div class="container mx-auto">
                <div class="w-full">
                    <h1 class="w-full font-bold text-5xl md:text-6xl text-tertiary-500 text-center tracking-wide pb-6">
                        Contactanos.</h1>
                </div>
                <div class="w-full">
                    <p class="w-full text-center text-xl md:text-2xl tracking-wide pb-6 text-white">Somos tu mejor
                        opcion.</p>
                </div>
            </div>
    ...
    <div class="pt-10">
        <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3911.0438206853555!2d-69.66919666958597!3d11.404363524589064!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e842b5223a46d51%3A0x100a5bd73f56ba2d!2sCentro%20Comercial%20Shopping%20Center!5e0!3m2!1ses-419!2sve!4v1706201578162!5m2!1ses-419!2sve"
...
<div id="openModal" class="modalDialog">
    <div id="modalWindow">
        ...
        <div id="form_section" class="w-full flex justify-center mt-8"></div>
    </div>
</div>
<?php
get_footer();
